...
// 이상의 문제를 해결하기 위한 방시긍로 사용할 수 있는 방법이
// 두 번 argument인 dependencies 배열을 이용하는 방법
...
// 초기 렌더링이 끝나면 컴포넌트가 마운드  해제 되고, 정리함수가 호출됐습니다.
...
function Counter() {
  ...
  }, [count, count2]);    // 둘 차이를 확인하기 위해 count2를 지웠다가 썼다가 실행해보시기 바랍니다.
